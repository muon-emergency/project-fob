...
namespace project_fob.Controllers
{
    public class HostController : Controller
    {
        ...
        public string CreateUrl(string meetingIdString)
        {
            ...
            return CreateUrlForTesting(meetingIdString, Request.GetDisplayUrl(), meet.RoomPassword);
        }

        public static string CreateUrlForTesting(string meetingIdString, string currentUrl, string roomPassword)
        {
